...
def TOP_P5_Sigma_HW_AM(s) {
	...
	partyOrder.sort(Comparator.comparing(player -> generalJobPrio.indexOf(player.job)));
	...
	s.waitMs(3_000);  // wait for clearing markers
